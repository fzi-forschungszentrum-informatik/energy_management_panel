...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('started_at', models.DateTimeField(help_text='The time this product run was started.')),
                ('available_at', models.DateTimeField(blank=True, help_text='Will be forwarded to product services and trigger those to compute only with data that has been available at this time.', null=True)),
                ...
                ('_plant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_runs', to='emp_main.plant')),
